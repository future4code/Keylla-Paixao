...
//1: a:
// a posição de cada item do array dentro do objeto

//2: a:
//vai retornar o nome dos componentes do array que esta dentro do objeto

//2: b:
//vai retornar o apelido dos componentes do array que esta dentro do objeto que sejam
//diferentes de chijo.

// respostas escrita de codigo

//array de cachorrinhos
...
const novoArray = pets.filter((array) => {
...
const mensagem = novoArray.map((item) =>{

    return item.nome
})
console.log (`Você ganhou um cupom de desconto de 10% 
para tosar o/a ${mensagem}!`)
...
//b) b) Crie um novo array que contenha um objeto com o nome
...
const produtos = [
 ...
 const novoArray= produtos.map((item) => {
    ...
    const desconto = item.preco - (item.preco * 0,05)
...
const produtos = [
 ...
 const novoArray = produtos.filter((array) => {
